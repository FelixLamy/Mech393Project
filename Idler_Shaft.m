...
gearbox.shaft.ID.tauMG2 = gearbox.shaft.ID.factors.ktsG2*VBG2(3,1)*(gearbox.shaft.ID.dG2/2)/((pi*gearbox.shaft.ID.dG2^4)/32);

gearbox.shaft.ID.sigmaAG2_VM = gearbox.shaft.ID.sigmaAG2;
gearbox.shaft.ID.sigmaMG2_VM = sqrt(3*(gearbox.shaft.ID.tauMG2^2));
...
gearbox.shaft.ID.tauMP3 = gearbox.shaft.ID.factors.ktsP3*VBP3(3,1)*(gearbox.shaft.ID.dP3/2)/((pi*gearbox.shaft.ID.dP3^4)/32);

gearbox.shaft.ID.sigmaAP3_VM = gearbox.shaft.ID.sigmaAP3;
gearbox.shaft.ID.sigmaMP3_VM = sqrt(3*(gearbox.shaft.ID.tauMP3^2));
